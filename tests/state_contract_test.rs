...
mod tests {
    ...
    use fuel_canary_watchtower::ethereum_watcher::state_contract::StateContract;
    // use crate::config::*;
    use std::sync::Arc;
    ...
    async fn pause_state_contract_test() {
        ...
        let result = state_contract.pause().await;
        ...
        mock.push_response(
            MockResponse::Value(serde_json::Value::String(pause_response_hex)),
        );
